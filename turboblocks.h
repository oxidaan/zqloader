...
/// This class can be seen as the c++ counterpart of the zqloader turboloader written in z80 assembler.
...
public:
    ...
    // Pause after loading zqloader itself (give BASIC some time)
