...
{
constexpr int zero_duration                = 81;  // 91;  // @@ see zqloader.asm
constexpr int one_duration                 = 241; // 241; //int(91 + 3.5 * 43); //250;  231 worked better with jsw3.z80!?
constexpr int end_of_byte_delay            = 64;

constexpr int bit_loop_max                 = 0;   // when 0 dont set (so keep defaults at zqloader.z80asm)
constexpr int bit_one_threshold            = 0;   // when 0 dont set (so keep defaults at zqloader.z80asm)
