...
/// - To loada block that overlaps our Z80 loader code (zqloader.z80asm) (at upper memory)
///   at the (now unused, but equaly sized) loader code at BASIC REM statement. Also moke sure it is last.
...
public:
    ...
    enum AfterBlock
    {
        ...
        CopyToScreen = 1,           // copy z80 loader code to screen, then go on to next block
