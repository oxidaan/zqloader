...
constexpr int g_spectrum_clock = 3500000;                         // 3.5 MHz clock speed of the ZX spectrum   
constexpr Doublesec g_tstate_dur = 1s / double(g_spectrum_clock); // Tstate duration as std::duration in seconds


// https://worldofspectrum.org/faq/reference/48kreference.htm
constexpr int g_tstate_leader = 2168;
constexpr int g_tstate_sync1 = 667;
constexpr int g_tstate_sync2 = 735;
constexpr int g_tstate_zero = 855;
constexpr int g_tstate_one = 1710;
// To speed up even ROM loading a bit:
constexpr int g_tstate_quick_zero = 700; // note 'quick_one' is taken as 2x this so 1400
